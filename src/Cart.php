...
namespace Treconyl\Shoppingcart;
...
use Treconyl\Shoppingcart\Contracts\Buyable;
use Treconyl\Shoppingcart\Exceptions\UnknownModelException;
use Treconyl\Shoppingcart\Exceptions\InvalidRowIDException;
use Treconyl\Shoppingcart\Exceptions\CartAlreadyStoredException;
...
class Cart
{
     ...
     * Add an item to the cart.
     *
     * @param \Treconyl\Shoppingcart\CartItem $item          Item to add to the Cart
     * @param bool                              $keepDiscount  Keep the discount rate of the Item
     * @param bool                              $keepTax       Keep the Tax rate of the Item
     * @param bool                              $dispatchEvent
     *
     * @return \Treconyl\Shoppingcart\CartItem The CartItem
     */
